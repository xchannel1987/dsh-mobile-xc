...
(() => {
  ...
  var LINES3 = [
    ...
    '  [data-mobile-nav="frame"] .eGxaPq_slot {',
    "    display: block !important;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_frame {',
    "    right: 6px !important;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_frame::after {',
    "    content: '';",
    "    position: absolute;",
    "    top: 0;",
    "    bottom: 0;",
    ...
    "    width: 40px;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_mark {',
    "    width: 30px !important;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_mark:before {',
    "    width: 18px !important;",
    "    height: 3px !important;",
    "    border-radius: 2px;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_markUnloaded:before {',
    "    width: 12px !important;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_markPreview:before {',
    "    width: 26px !important;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_markActive:before {',
    "    width: 28px !important;",
    "    background: var(--dsw-alias-state-business-primary, #4f6ef2) !important;",
    "  }",
    '  [data-mobile-nav="frame"] .eGxaPq_frame:active .eGxaPq_markActive:before {',
    "    width: 30px !important;",
    "    background: var(--dsw-alias-state-business-primary, #4f6ef2) !important;",
    "  }",
    "",
