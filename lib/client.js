...
(() => {
  ...
  var DEFAULTS = { dragEnabled: false, dshmarketNavFix: true, pwaEnabled: true, drawerRefresh: false };
  function load() {
  ...
  function installMobileGesture(ctx, toggleSidebar) {
    installMobileEffect(ctx, "dsh-mobile-xc: gesture", () => {
      ...
      const drawerEl = () => document.querySelector('[data-mobile-nav="frame"] > [data-mobile-nav="drawer"]');
