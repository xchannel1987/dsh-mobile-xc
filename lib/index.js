...
var XC_SETTINGS_NS = "dsh-mobile-xc";
var XcSettings = Schema.object({
  swipeEnabled: Schema.boolean().default(true).extra("volatile", true),
  dshmarketNavFix: Schema.boolean().default(true).extra("volatile", true),
  pwaEnabled: Schema.boolean().default(true).extra("volatile", true),
  drawerRefresh: Schema.boolean().default(false).extra("volatile", true),
  headerScroll: Schema.boolean().default(true).extra("volatile", true),
  turnRail: Schema.boolean().default(true).extra("volatile", true)
});
var Config = XcSettings;
